...
DeepeResearch supports local inference via Ollama (auto-discovered on localhost:11434) and configurable endpoints for llama.cpp, vLLM, and SGLang. See **[ADR-0005](docs/adr/ADR-0005-auto-install-and-discover-local-llm-backends.md)** for the auto-install and auto-discovery design.
...
- **[ADR-0001](docs/adr/ADR-0001-multi-agent-research-architecture.md)**: Multi-Agent Research Architecture
- **[ADR-0002](docs/adr/ADR-0002-agent-personality-and-model-selection.md)**: Agent Personality and Model Selection
